...
// Key = Claude stem, value = TOML stem. Empty here — this fork's TOML
// generator (scratchpad/gen-toml.mjs) always mirrors the .claude/commands
// stem exactly, unlike upstream's plan.md -> planning.toml rename.
const NAME_MAP = {};
