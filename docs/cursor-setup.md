...
Treat `agent-skills/skills/` (or a cloned [dzikrisyairozi/claude-multi-agent-dev](https://github.com/dzikrisyairozi/claude-multi-agent-dev)) as **upstream** — sync into `.cursor/skills/`, do not edit only upstream and expect Cursor to see it.
...
- Upstream: [github.com/dzikrisyairozi/claude-multi-agent-dev](https://github.com/dzikrisyairozi/claude-multi-agent-dev)
