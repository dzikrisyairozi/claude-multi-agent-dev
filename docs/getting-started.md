...
[dzikrisyairozi/claude-multi-agent-dev#361](https://github.com/dzikrisyairozi/claude-multi-agent-dev/issues/361).

## Spec and task artifacts

The `/spec` and `/plan` commands create working artifacts (`spec/<feature-name>/spec.md`, `tasks/<feature-name>/plan.md`, `tasks/<feature-name>/todo.md`). Treat them as **living documents** while the work is in progress:
